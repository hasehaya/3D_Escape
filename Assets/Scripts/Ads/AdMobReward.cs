...
#if UNITY_ANDROID
        adUnitId = "ca-app-pub-2788807416533951/4403325655";//ここにAndroidのリワード広告IDを入力
#elif UNITY_IPHONE
        adUnitId = "ca-app-pub-2788807416533951/9434106429";//ここにiOSのリワード広告IDを入力
#else
